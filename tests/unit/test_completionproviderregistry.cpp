...
void TestCompletionProviderRegistry::testRegisterProvider()
{
    ...
    QCOMPARE(registry.getProvider("test_provider")->displayName(), QString("Test Provider"));
}
...
void TestCompletionProviderRegistry::testRegisterDuplicateReplace()
{
    ...
    QCOMPARE(registry.providerCount(), 1);
    QCOMPARE(registry.getProvider("test_id")->displayName(), QString("Provider 1"));
    
    registry.registerProvider(provider2);
    QCOMPARE(registry.providerCount(), 1);
    QCOMPARE(registry.getProvider("test_id")->displayName(), QString("Provider 2"));
}
...
void TestCompletionProviderRegistry::testAllTriggerCharacters()
{
    ...
    registry.registerProvider(std::make_shared<MockCompletionProvider>(
        "py_lsp", "Python LSP", 10, QStringList{"python"},
        QStringList{"."}
    ));
    registry.registerProvider(std::make_shared<MockCompletionProvider>(
        "keywords", "Keywords", 100, QStringList{"*"},
        QStringList{}
    ));
...
void TestCompletionProviderRegistry::testSignals()
{
    ...
    QSignalSpy registeredSpy(&registry, &CompletionProviderRegistry::providerRegistered);
    QSignalSpy unregisteredSpy(&registry, &CompletionProviderRegistry::providerUnregistered);
    ...
    QCOMPARE(unregisteredSpy.takeFirst().at(0).toString(), QString("signal_test"));
