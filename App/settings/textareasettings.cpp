...
TextAreaSettings::TextAreaSettings()
    : mainFont(QApplication::font()), autoIndent(true),
      showLineNumberArea(true), lineHighlighted(true),
      matchingBracketsHighlighted(true), vimModeEnabled(false),
...
void TextAreaSettings::read(const QJsonObject &json) {
  ...
  if (json.contains("showLineNumberArea") &&
      json["showLineNumberArea"].isBool())
  ...
  if (json.contains("matchingBracketsHighlighted") &&
      json["matchingBracketsHighlighted"].isBool())
