...
void SettingsManager::initializeDefaults() {
  ...
  m_defaults["showTerminalDock"] = false;
  m_defaults["showProblemsDock"] = false;
  m_defaults["showTestDock"] = false;
  m_defaults["showMarkdownPreviewDock"] = false;
  m_defaults["showLatexPreviewDock"] = false;
  m_defaults["currentFilePath"] = "";
  m_defaults["markdownPreviewFilePath"] = "";
  m_defaults["latexPreviewFilePath"] = "";
  m_defaults["mainWindowDockState"] = "";
  m_defaults["showFindReplacePanel"] = false;
  m_defaults["findReplaceOnlyFind"] = true;
  m_defaults["findReplaceGlobalMode"] = false;
  m_defaults["showPreferencesDialog"] = false;
  m_defaults["showRunConfigurationDialog"] = false;
  m_defaults["showFormatConfigurationDialog"] = false;
  m_defaults["showDebugConfigurationDialog"] = false;
  m_defaults["showShortcutsDialog"] = false;
  m_defaults["showCommandPalette"] = false;
  m_defaults["showGoToLineDialog"] = false;
  m_defaults["showGoToSymbolDialog"] = false;
  m_defaults["showFileQuickOpen"] = false;
  m_defaults["showRecentFilesDialog"] = false;
