...
// ---------------------------------------------------------------------------
// Hacker Dark — deep blacks, neon green accents, cyan highlights
// ---------------------------------------------------------------------------
ThemeDefinition hackerDark() {
  // Default constructor already builds Hacker Dark
  return ThemeDefinition();
}

// ---------------------------------------------------------------------------
// Midnight Blue — evolved from the current legacy Theme defaults
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Cyberpunk — hot pink + electric blue, neon glow
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Matrix — green phosphor with enough contrast for code structure
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Ghost — minimal monochrome, white accent
// ---------------------------------------------------------------------------
ThemeDefinition ghost() {
  ...
  // Syntax — near monochrome with subtle luminance variation
