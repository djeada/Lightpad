...
ThemeDefinition::ThemeDefinition() {
  ...
  // -- Editor --
  colors.editorBg           = QColor("#0a0e14");
  colors.editorFg           = QColor("#b3b1ad");
  colors.editorGutter       = QColor("#0a0e14");
  colors.editorGutterFg     = QColor("#464d56");
  colors.editorLineHighlight= QColor("#0f1419");
  colors.editorSelection    = QColor("#1a3a2a");
  colors.editorSelectionFg  = QColor("#e6e1cf");
  colors.editorCursor       = QColor("#00ff41");
  colors.editorFindMatch    = QColor("#33cc3340");
  colors.editorFindMatchActive = QColor("#00ff4180");
  colors.editorBracketMatch = QColor("#00ff4140");
  colors.editorIndentGuide  = QColor("#1c2127");
  colors.editorWhitespace   = QColor("#2d3640");

  // -- Syntax --
  colors.syntaxKeyword   = QColor("#00ff41");
  colors.syntaxKeyword2  = QColor("#00d7ff");
  colors.syntaxKeyword3  = QColor("#f2d15c");
  colors.syntaxString    = QColor("#9cff6e");
  colors.syntaxComment   = QColor("#4d6a57");
  colors.syntaxFunction  = QColor("#7df9ff");
  colors.syntaxClass     = QColor("#5cffb1");
  colors.syntaxNumber    = QColor("#ffb454");
  colors.syntaxOperator  = QColor("#ff5f87");
  colors.syntaxType      = QColor("#5cffb1");
  colors.syntaxConstant  = QColor("#ffee99");
  colors.syntaxTag       = QColor("#00d7ff");
  colors.syntaxAttribute = QColor("#f2d15c");
  colors.syntaxRegex     = QColor("#c792ea");
  colors.syntaxEscape    = QColor("#ff9f43");

  // -- Surfaces --
  colors.surfaceBase    = QColor("#0a0e14");
  colors.surfaceRaised  = QColor("#0f1419");
  colors.surfaceOverlay = QColor("#141925");
  colors.surfaceSunken  = QColor("#060a0f");
  colors.surfacePopover = QColor("#161f2a");

  // -- Borders --
  colors.borderDefault = QColor("#1c2a1c");
  colors.borderSubtle  = QColor("#141a14");
  colors.borderStrong  = QColor("#2a3a2a");
  colors.borderFocus   = QColor("#00ff41");

  // -- Text --
  colors.textPrimary   = QColor("#b3b1ad");
  colors.textSecondary = QColor("#626a73");
  colors.textMuted     = QColor("#464d56");
  colors.textDisabled  = QColor("#333a42");
  colors.textInverse   = QColor("#0a0e14");
  colors.textLink      = QColor("#00ff41");

  // -- Buttons --
  colors.btnPrimaryBg     = QColor("#00ff41");
  colors.btnPrimaryFg     = QColor("#0a0e14");
  colors.btnPrimaryHover  = QColor("#33ff66");
  colors.btnPrimaryActive = QColor("#00cc34");
  colors.btnSecondaryBg     = QColor("#1c2a1c");
  colors.btnSecondaryFg     = QColor("#b3b1ad");
  colors.btnSecondaryHover  = QColor("#243424");
  colors.btnSecondaryActive = QColor("#142014");
  ...
  colors.btnGhostHover  = QColor("#0f1419");
  colors.btnGhostActive = QColor("#141925");

  // -- Input --
  colors.inputBg          = QColor("#0f1419");
  colors.inputFg          = QColor("#b3b1ad");
  colors.inputBorder      = QColor("#1c2a1c");
  colors.inputBorderFocus = QColor("#00ff41");
  colors.inputPlaceholder = QColor("#464d56");
  colors.inputSelection   = QColor("#1a3a2a");

  // -- Accent --
  colors.accentPrimary = QColor("#00ff41");
  colors.accentSoft    = QColor("#0a3a1a");
  colors.accentGlow    = QColor("#00ff4140");

  // -- Scrollbar --
  colors.scrollTrack     = QColor("#0a0e14");
  colors.scrollThumb     = QColor("#1c2a1c");
  colors.scrollThumbHover= QColor("#2a3a2a");

  // -- Tab --
  colors.tabBg           = QColor("#0a0e14");
  colors.tabActiveBg     = QColor("#0f1419");
  colors.tabActiveBorder = QColor("#00ff41");
  colors.tabHoverBg      = QColor("#0d1218");
  colors.tabFg           = QColor("#626a73");
  colors.tabActiveFg     = QColor("#b3b1ad");

  // -- Tree --
  colors.treeSelectedBg  = QColor("#0f1e14");
  colors.treeHoverBg     = QColor("#0d1218");
  colors.treeIndentGuide = QColor("#1c2127");

  // -- Terminal --
  colors.termBg        = QColor("#0a0e14");
  colors.termFg        = QColor("#b3b1ad");
  colors.termCursor    = QColor("#00ff41");
  colors.termSelection = QColor("#1a3a2a");

  colors.ansiBlack   = QColor("#0a0e14");
  colors.ansiRed     = QColor("#f85149");
  colors.ansiGreen   = QColor("#00ff41");
  colors.ansiYellow  = QColor("#e6b450");
  colors.ansiBlue    = QColor("#59c2ff");
  colors.ansiMagenta = QColor("#d2a8ff");
  colors.ansiCyan    = QColor("#39bae6");
  colors.ansiWhite   = QColor("#b3b1ad");

  colors.ansiBrightBlack   = QColor("#626a73");
  colors.ansiBrightRed     = QColor("#fa6e68");
  colors.ansiBrightGreen   = QColor("#33ff66");
  colors.ansiBrightYellow  = QColor("#ffee99");
  colors.ansiBrightBlue    = QColor("#79c0ff");
  colors.ansiBrightMagenta = QColor("#e2c5ff");
  colors.ansiBrightCyan    = QColor("#95e6cb");
  colors.ansiBrightWhite   = QColor("#e6e1cf");

  // -- Status --
  colors.statusSuccess = QColor("#00ff41");
  colors.statusWarning = QColor("#e6b450");
  colors.statusError   = QColor("#f85149");
  colors.statusInfo    = QColor("#59c2ff");

  // -- UI config --
  ui.borderRadius    = 6;
  ui.glowIntensity   = 0.35;
...
ThemeDefinition ThemeDefinition::fromClassicTheme(const Theme &c, const QString &themeName) {
  ThemeDefinition d;
  d.name   = themeName;
  d.author = "User";
  d.type   = "dark";
  ...
  d.colors.accentGlow    = QColor(c.accentColor.red(), c.accentColor.green(), c.accentColor.blue(), 64);
  ...
  d.colors.ansiBrightMagenta = lerp(lerp(c.errorColor, c.accentColor, 0.5), c.foregroundColor, 0.2);
  d.colors.ansiBrightCyan    = lerp(lerp(c.accentColor, c.successColor, 0.5), c.foregroundColor, 0.2);
...
// Helper to read a color from a nested dot-notation key
...
// Helper to write a color into a nested dot-notation key
static void writeColor(QJsonObject &root, const QString &key, const QColor &c) {
  ...
  QJsonObject sub = root.contains(group) ? root[group].toObject() : QJsonObject();
...
void ThemeDefinition::read(const QJsonObject &json) {
  ...
  auto apply = [](QColor &dest, const QColor &src) { if (src.isValid()) dest = src; };
...
void ThemeDefinition::write(QJsonObject &json) const {
  ...
  auto w = [&](const QString &key, const QColor &c) { writeColor(json, key, c); };
