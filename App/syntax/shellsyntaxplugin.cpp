...
{
    return {
        "break", "continue", "return", "exit", "shift", "source", "alias",
        "unalias", "export", "readonly", "declare", "local", "typeset",
        "unset", "set", "shopt", "trap", "eval", "exec", "true", "false"
    };
}
...
QStringList ShellSyntaxPlugin::getTertiaryKeywords()
{
    return {
        ...
        "head", "tail", "wc", "cut", "paste", "tr", "test", "expr"
    };
}
