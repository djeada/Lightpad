...
QStringList WgslSyntaxPlugin::getSecondaryKeywords() {
  return {"if",          "else",     "loop",       "for",      "while",
          "break",       "continue", "return",     "switch",   "case",
          "default",     "discard",  "continuing", "break_if", "fn",
          "struct",      "var",      "let",        "const",    "type",
          "override",    "alias",    "enable",     "requires", "diagnostic",
          "const_assert"};
}
...
QVector<MultiLineBlock> WgslSyntaxPlugin::multiLineBlocks() const { return {}; }
