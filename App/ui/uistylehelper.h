...
public:
    /**
     * @brief Generate stylesheet for popup dialogs (command palette, quick open, etc.)
     */
    ...
    /**
     * @brief Generate stylesheet for panel headers (breadcrumb, problems panel header, etc.)
     */
