...
ImageViewer::ImageViewer(QWidget *parent)
    : QWidget(parent), m_graphicsView(nullptr), m_scene(nullptr),
      m_pixmapItem(nullptr), m_toolbar(nullptr), m_zoomLabel(nullptr),
      m_infoLabel(nullptr), m_zoomFactor(1.0), m_initialFitPending(false) {
  setupUi();
}
...
void ImageViewer::setupToolbar() {
  ...
  connect(actualSizeAction, &QAction::triggered, this,
