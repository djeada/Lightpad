...
void FileQuickOpen::setupUI()
{
    ...
    // Connections
    connect(m_searchBox, &QLineEdit::textChanged, this, &FileQuickOpen::onSearchTextChanged);
    connect(m_resultsList, &QListWidget::itemActivated, this, &FileQuickOpen::onItemActivated);
    connect(m_resultsList, &QListWidget::itemClicked, this, &FileQuickOpen::onItemClicked);

    // Install event filter for keyboard navigation
    m_searchBox->installEventFilter(this);

    setStyleSheet("FileQuickOpen { background: #171c24; border: 1px solid #2a3241; border-radius: 8px; }");
}
