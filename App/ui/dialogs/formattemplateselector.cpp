...
FormatTemplateSelector::FormatTemplateSelector(const QString& filePath, QWidget* parent)
    : QDialog(parent)
    , m_filePath(filePath)
{
    setupUi();
    ...
    FileFormatAssignment assignment = FormatTemplateManager::instance().getAssignmentForFile(filePath);
...
void FormatTemplateSelector::setupUi()
{
    ...
    connect(m_searchEdit, &QLineEdit::textChanged, this, &FormatTemplateSelector::onFilterChanged);
    filterLayout->addWidget(m_searchEdit);
    
    m_languageCombo = new QComboBox();
    m_languageCombo->addItem("All Languages");
    connect(m_languageCombo, &QComboBox::currentTextChanged, this, &FormatTemplateSelector::onLanguageFilterChanged);
    ...
    connect(m_templateList, &QListWidget::itemClicked, this, &FormatTemplateSelector::onTemplateSelected);
    ...
    connect(m_removeButton, &QPushButton::clicked, this, &FormatTemplateSelector::onRemoveAssignment);
    ...
    connect(m_okButton, &QPushButton::clicked, this, &FormatTemplateSelector::onAccept);
...
void FormatTemplateSelector::loadTemplates()
{
    ...
    QList<FormatTemplate> matchingTemplates = manager.getTemplatesForExtension(ext);
...
void FormatTemplateSelector::onTemplateSelected(QListWidgetItem* item)
{
    ...
    FormatTemplate tmpl = FormatTemplateManager::instance().getTemplateById(templateId);
