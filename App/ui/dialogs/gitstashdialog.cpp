...
GitStashDialog::GitStashDialog(GitIntegration* git, QWidget* parent)
    ...
    , m_includeUntrackedCheckbox(nullptr)
...
void GitStashDialog::setupUI()
{
    ...
    QLabel* subtitleLabel = new QLabel(tr("Save your work in progress for later"), this);
    ...
    m_includeUntrackedCheckbox = new QCheckBox(tr("Include untracked files"), this);
    m_includeUntrackedCheckbox->setToolTip(tr("Also stash files that are not yet tracked by git"));
    optionsLayout->addWidget(m_includeUntrackedCheckbox);
    optionsLayout->addStretch();
    
    m_stashButton = new QPushButton(tr("Stash Changes"), this);
    connect(m_stashButton, &QPushButton::clicked, this, &GitStashDialog::onStashClicked);
    ...
    connect(m_stashList, &QListWidget::itemClicked, this, &GitStashDialog::onStashSelected);
    ...
    connect(m_popButton, &QPushButton::clicked, this, &GitStashDialog::onPopClicked);
    ...
    connect(m_applyButton, &QPushButton::clicked, this, &GitStashDialog::onApplyClicked);
    ...
    connect(m_dropButton, &QPushButton::clicked, this, &GitStashDialog::onDropClicked);
    ...
    connect(m_clearButton, &QPushButton::clicked, this, &GitStashDialog::onClearClicked);
    ...
    connect(m_closeButton, &QPushButton::clicked, this, &GitStashDialog::onCloseClicked);
...
void GitStashDialog::updateStashList()
{
    ...
    for (const GitStashEntry& stash : stashes) {
        ...
        QString text = QString("stash@{%1}: %2")
            .arg(stash.index)
...
void GitStashDialog::onDropClicked()
{
    ...
    int result = QMessageBox::question(this, tr("Drop Stash"),
        QString(tr("Are you sure you want to drop stash@{%1}?\nThis cannot be undone.")).arg(index),
...
void GitStashDialog::onClearClicked()
{
    ...
    int result = QMessageBox::warning(this, tr("Clear All Stashes"),
        tr("Are you sure you want to clear all stash entries?\nThis action cannot be undone!"),
        QMessageBox::Yes | QMessageBox::No, QMessageBox::No);
