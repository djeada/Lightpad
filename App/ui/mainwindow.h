...
private:
  ...
  void applyTreeCurrentIndexToView(QTreeView *treeView);
  ...
  void updateAllTextAreas(void (TextArea::*f)(const Theme &),
                          const Theme &theme);
  ...
  QItemSelectionModel *m_fileTreeSelectionModel;
