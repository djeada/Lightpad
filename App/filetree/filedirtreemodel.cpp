...
bool FileDirTreeModel::createNewFile(const QString& dirPath, const QString& fileName)
{
...
bool FileDirTreeModel::createNewDirectory(const QString& parentPath, const QString& dirName)
{
...
bool FileDirTreeModel::renameFileOrDirectory(const QString& oldPath, const QString& newPath)
{
...
{
    if (clipboardPath.isEmpty() || clipboardOperation == ClipboardOperation::None) {
    ...
    // If destPath is a file, use its parent directory
...
bool FileDirTreeModel::copyRecursively(const QString& srcPath, const QString& destPath)
{
