...
public:
    ...
    int minimumPrefixLength() const override { return 0; }  // LSP handles its own triggering
    ...
    bool isEnabled() const override { return m_enabled && m_client && m_client->isReady(); }
...
private slots:
    void onCompletionReceived(int requestId, const QList<LspCompletionItem>& items);
