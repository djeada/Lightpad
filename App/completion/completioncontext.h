...
struct CompletionContext {
    ...
    bool isValid() const {
        ...
        return !prefix.isEmpty() || triggerKind == CompletionTriggerKind::TriggerCharacter;
    }
     ...
     */
    static CompletionContext createInvoked(
        const QString& uri,
        const QString& lang,
     ...
     * @return Configured context
     */
    static CompletionContext createTriggerChar(
        const QString& uri,
        const QString& lang,
