...
public:
     ...
     */
    void setAdapterSettings(const QString& adapterId, const QJsonObject& settings);
     ...
     */
    void setDefaultAdapterForExtension(const QString& extension, const QString& adapterId);
